...
namespace ConsultaARSHospital.Controllers
{
    public class EstatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_estatus,nombre_estatus,descripcion")] Estatus estatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_estatus,nombre_estatus,descripcion")] Estatus estatus)
        {
            if (ModelState.IsValid)
            {
